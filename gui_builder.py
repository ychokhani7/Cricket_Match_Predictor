...
l4 = Label(master, text = "Match Date") 
l5 = Label(master, text = "Toss Winner") 
l6 = Label(master, text = "VS", font=("Helvetica", 12, 'italic')) 
...
teamAlogo = Label(master, image = img1A).grid(row = 0, column = 0, 
...
# setting image with the help of label 
teamBlogo = Label(master, image = img1B).grid(row = 0, column = 4, 
       columnspan = 3, rowspan = 3, padx = 5, pady = 20) 

def teamASelected(event):
    # imgtemp =  PhotoImage(file = imgAddressPrefix+imageTeams[8])
